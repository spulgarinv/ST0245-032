...
public class GraphAlgorithms {
  ...
  static int [] dijsktra(Graph dg, int source)
  {
    ...
    public static int VerticeConMasSucesores(Graph grafo){
        int NumeroDeSucesores =0;
        int VerticeConMayorSucesores = -1;
        
        for(int vertex=0; vertex<grafo.size(); vertex++){
            ArrayList successors = grafo.getSuccessors(vertex);
            if(successors.size()>NumeroDeSucesores){
                NumeroDeSucesores = successors.size();
                VerticeConMayorSucesores = vertex;
            }    
        }
        
        return VerticeConMayorSucesores;
    }
 ...
 public static void main(String[] args)
 {
     ...
     GraphAlgorithms.dibujarGrafo(dgal);
 }
}
